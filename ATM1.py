...
print()
accounts = {
    1001 : ["Sonu 1","24-08-2024",10000,2408],
    1002 : ["Chandu 2","16-07-2024",20000,1234],
    1003 : ["Lucky 3","20-01-2024",5000,None]    
    }
            ...
            if accounts[accno][-1] == None:
                ...
                if accounts[accno][-1] != pin:
                    ...
                    if amt > accounts[accno][-2]:
                        ...
                        print(f"hi,{accounts[accno][0]} Withdraw Sucessfull !")
                        accounts[accno][-2] =accounts[accno][-2]-amt
        print("**********************")
    elif option == 2:
        print("**********************")
        accno = int(input("Enter Account Number: "))
